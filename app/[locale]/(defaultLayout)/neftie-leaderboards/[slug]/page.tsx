...
import NeftieLeaderboards from "./view";
...
export default async function Page({ params }: { params: { slug: string } }) {
  ...
  return <NeftieLeaderboards slug={params.slug} />;
}
...
export async function generateMetadata(
  ...
  return {
    title: t("translation:page_information:neftie_leaderboard.title", {
      slug: capitalizeWords(params.slug),
      patch: CURRENT_PATCH_VERSION,
    }),
    description: t("translation:page_information:neftie_leaderboard.description", {
      slug: capitalizeWords(params.slug),
      patch: CURRENT_PATCH_VERSION,
    }),
  };
